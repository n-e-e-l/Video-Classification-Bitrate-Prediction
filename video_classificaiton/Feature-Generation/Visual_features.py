...
data = {'filename': ['File1.mp4', 'File2.mp4', 'File3.mp4'], 'video_b':[22,22,22], 'video_g':[22,22,22], 'video_r':[22,22,22], 'video_h':[22,22,22], 'video_s':[22,22,22],'video_v':[22,22,22],
        'contrast':[22,22,22],'dissimilarity':[22,22,22],'homogeneity':[22,22,22],'energy':[22,22,22],'correlation':[22,22,22]}
# Create DataFrame.
...
df.to_csv( "drive/My Drive/df_visual.csv", encoding='utf-8') #saving various features from a video files
